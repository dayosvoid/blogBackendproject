const User = require("../model/auth.model.js") //require out schema structure used to query the database
...
const login = async (req, res) => {
    ...
    //function to generate token when user is authenticated below;
